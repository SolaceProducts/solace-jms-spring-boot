...
@Configuration @EnableJms public class JndiConsumerConfiguration {
  ...
  @Bean public JndiObjectFactoryBean connectionFactory() {
  ...
  @Bean public JndiDestinationResolver jndiDestinationResolver() {
  ...
  @Bean public DefaultJmsListenerContainerFactory cFactory(DemoErrorHandler errorHandler) {
  ...
  @Bean public DefaultJmsListenerContainerFactory tFactory(DemoErrorHandler errorHandler) {
    DefaultJmsListenerContainerFactory factory = new DefaultJmsListenerContainerFactory();
    factory.setConnectionFactory((ConnectionFactory) connectionFactory().getObject());
    factory.setErrorHandler(errorHandler);
  ...
  @Bean public SimpleJmsListenerContainerFactory sFactory(DemoErrorHandler errorHandler) {
  ...
  @Service public class DemoErrorHandler implements ErrorHandler {
